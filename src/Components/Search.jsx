...
const SearchBox = () => {
  ...
  return (
    <div className='w-fit h-fit pt-10 pr-10 relative'>
        ...
        >    
        <input type="text" className='cursor-pointer h-12 w-12 pl-12 font-medium rounded-full transition-all duration-500 ease-in-out bg-green-700 text-black placeholder-green-700 placeholder:text-center' 
        placeholder='Search...'
